...
import {getArticleDetailFailur, getArticleDetailStart, getArticleDetailSuccess} from "../slice/Article";
...
const ArticleDetail = () => {
    ...
    const getArticleDetail = async () => {
        ...
        await ArticleService.getArticleDetails(slug)
            .then(res => {
                dispatch(getArticleDetailSuccess(res.article))
            }).catch(err => {
                dispatch(getArticleDetailFailur(err.response.data.errors))
            })
    }
                ...
                <div className='py-3 mb-4  rounded-3'>
                    <div className='container-fluid pb-5'>
                        ...
                        <p className='text-muted'>
                            <span
                                className='fw-bold'>Created at:</span> {moment(articleDetail.createdAt).format('DD MMM, YYYY ,HH:mm:ss:MM')}
                        </p>
                        <div className='col-md-6'>
                            <div
                                ...
                                <div className='col p-4 d-flex flex-column position-static'>
                                    <strong
                                        className='d-inline-block mb-2 text-primary text-uppercase'>{articleDetail.author.username}</strong>
